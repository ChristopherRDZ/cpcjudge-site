...
from judge.admin.announcement import AnnouncementAdmin
from judge.admin.clarification import ContestClarificationAdmin
...
admin.site.register(ContestClarification, ContestClarificationAdmin)
